const { mainProduct, products, sizes, reviews, notifications, bottomRow } =
  window.__config;
...
const mainInit = () => {
  ...
  // barText.innerText = bottomRow.bar;
  // accountText.innerText = bottomRow.account;
  // heartText.innerText = bottomRow.heart;
  // bagText.innerText = bottomRow.bag;
  // findText.innerText = bottomRow.find;
